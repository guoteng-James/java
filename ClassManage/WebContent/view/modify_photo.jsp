...
<body>
<center>
<%-- ${pageContext.request.contextPath }/logon.do?action=modify_login_photo&id=${login_id} --%>
   <form action="/ClassManage/logon.do?action=upload&id=${login_id}&p_address=student_img" method="post" enctype="multipart/form-data">
<!-- <form action="/ClassManage/pic/upload" method="post" enctype="multipart/form-data"> -->
...
<%--      		<img id="img" src="${pageContext.request.contextPath }/images/student_img/${photo}"  style="width: 2.5cm;height: 3.5cm;"/> --%>
		<img id="img" src="${photo}"  style="width: 2.5cm;height: 3.5cm;"/>
     		<br/>
